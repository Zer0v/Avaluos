...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-04-2014 a las 17:29:20
...
(1, NULL, NULL, 1396876813, 'admin', 'admin@tucorreo.com', 'avaluospass', NULL, 1, 0, 0),
...
(2, 2, 'Dagoberto', '3111037', 'Dolly Yepes', 'Oficios Varios2', 'Medellin'),
(3, 3, 'aa', 'aa', 'aa', 'aa', 'aaaa');
...
(2, 'Edificio Combeima', '800001581-4', 'Carrera 42 # 1 Sur - 48', '23/04/2014', 'ad'),
(3, 'a', 'a', 'a', '04/04/2014', 'a');
