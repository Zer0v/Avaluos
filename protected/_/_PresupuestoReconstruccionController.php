...
class PresupuestoReconstruccionController extends Controller
{
	...
	public function filters()
   {
	...
	{
		$model=new InformacionPresupuestoReconstruccion;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		/*if(isset($_POST['InformacionPresupuestoReconstruccion']))
		{
			$model->attributes=$_POST['InformacionPresupuestoReconstruccion'];
			if($model->save())
				$this->redirect(array('update','id'=>$model->idPresupuestoReconstruccion));
		}*/
